  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "wallets"."ledger_entries" (
        ...
        CONSTRAINT "FK_ledger_entries_wallet" FOREIGN KEY ("wallet_id") REFERENCES "wallets"."wallets"("id") ON DELETE RESTRICT ON UPDATE CASCADE
      )
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP TABLE "wallets"."ledger_entries"');
  }
}
